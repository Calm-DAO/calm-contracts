...
contract sCalm is ERC20Permit, Ownable {
  using LowGasSafeMath for uint256;
  ...
  constructor() ERC20("Staked CALM", "sCALM", 9) ERC20Permit() {
  ...
  /**
        @notice increases sCalm supply to increase staking balances relative to profit_
    ...
    returns (uint256)
  {
    ...
    console.log("Circ supply", circulatingSupply_);
    console.log("Profit", profit_);
  ...
  // Staking contract holds excess sCalm
